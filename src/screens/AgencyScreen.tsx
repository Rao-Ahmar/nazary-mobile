      ...
      >
        ...
        <Animated.View style={[styles.section, fadeStyle(tripsSectionAnim)]}>
          ...
          {agencyTrips.map((trip, index) => {
            ...
            return (
              <Animated.View
                key={trip.id}
                style={[styles.tripCard, shadows.soft, fadeStyle(tripAnims[index])]}
              >
                      ...
                      <View
                        style={[
                          styles.progressFill,
                          {
                            ...
                            backgroundColor: fillPercentage >= 100 ? colors.success : colors.primary,
                          },
                        ]}
                      />
                    </View>
        ...
        <Animated.View style={[styles.section, fadeStyle(bookingsSectionAnim)]}>
          ...
          {recentBookings.map((booking, index) => (
            <Animated.View
              key={booking.id}
              style={[styles.bookingCard, shadows.soft, fadeStyle(bookingAnims[index])]}
            >
              ...
              <View style={styles.bookingRight}>
                ...
                <View style={[
                  ...
                  { backgroundColor: booking.status === 'confirmed' ? colors.successLight : colors.warningLight }
                ]}>
                  <Text style={[
